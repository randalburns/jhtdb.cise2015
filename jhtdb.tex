...
\begin{figure*}
\frame{\includegraphics[width=1.0\textwidth]{ip_map.pdf}}
...
Data from the service have been used fully or partially in multiple research projects resulting in at least 40 peer-reviewed publications. The impact of the JHDTB has extended to the classroom as well. The laboratory has been used in various classes and student workshops 
...
turbulence research. For example, a generalization of previous models of turbulent dispersion was 
first applied to JHTDB data by Benveniste et al. \cite{benveniste2014asymptotic}. Luethi et al. \cite{luethi2009expanding} have used the JHTDB to develop
a better understanding of velocity gradient dynamics. Pumir et al. \cite{pumir2014redistribution} drew the
conclusion that ``pressure forces tend, on average, to accelerate
fast particles" by utilizing the the tools and data provided by the JHTDB. These are just a handful of the many examples showing the utility of the 
